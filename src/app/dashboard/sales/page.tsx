...
import { CustomersFilters } from '@/components/dashboard/sales/customers-filters';
import { CustomersTable } from '@/components/dashboard/sales/customers-table';
import type { Customer } from '@/components/dashboard/sales/customers-table';
